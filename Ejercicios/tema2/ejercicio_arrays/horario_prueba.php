<?php
    ...
    $horario = [
        ...
        2=> [$asignaturas[1],$asignaturas[4],$asignaturas[4],$recreo[0],$asignaturas[5],$asignaturas[5],$asignaturas[5]],
        3=> [$asignaturas[5],$asignaturas[5],$asignaturas[5],$recreo[0],$asignaturas[3],$asignaturas[3],$asignaturas[3]],
        4=> [$asignaturas[2],$asignaturas[4],$asignaturas[4],$recreo[0],$asignaturas[3],$asignaturas[3],$asignaturas[3]],
        5=> [$asignaturas[3],$asignaturas[3],$asignaturas[3],$recreo[0],$asignaturas[0],$asignaturas[0],$asignaturas[0]],
    ];
...
<head>
    ...
    <title>Horario</title>
    <link rel="stylesheet" href="estilos_arrays.css">
</head>
<body>
    <table>
        <tr>    
