<?php
    ...
    class trabajador extends persona { //clase que hereda de la clase persona
        public $puesto;
    ...
    $objTrabajador->asignarNombre("Pepe Pérez");
    $objTrabajador->puesto="Profesor";
   
    $objTrabajador->presentacionTrabajador();
